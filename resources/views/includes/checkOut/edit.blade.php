...
<div id="edit{{ $checkOut->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('checkOuts.update', $checkOut->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input class="form-control" value="{{ $checkOut->date_issued->toDateString() }}"  type="date" name="date_issued" >
                        </div>
                    </div>
